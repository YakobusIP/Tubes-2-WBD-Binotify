...
function NavbarUser() {
    ...
    return (
        <nav className="sticky top-0 flex flex-row bg-main-black-2 justify-between items-center px-4 py-2 font-main">
            <img className="w-1/8 justify-start m-2" src="../src/assets/binotify-white.svg" alt="Logo"/>
            <div className="flex flex-row m-2 justify-end">
                <button className="flex flex-row items-center p-1 mr-4 rounded-full bg-black border-bg-black hover:bg-main-black-3 hover:border-main-black-3">
                    ...
                    {
                        username ?
                            <p className="font-bold text-white m-0 text-md pl-1 pr-2">{username}</p>
                        :
                            <p className="font-bold text-white m-0 text-md pl-1 pr-2">Username</p>
                    }
